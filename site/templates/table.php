...
<main class="main">
    <section class="section">
        <table id="table" class="table" width="100%">
            <tr class="list-item-topbar list-item-topbar-header">
            ...
            <?php foreach ($page->children()->listed()->sortBy('year', 'desc') as $project) : ?>
                <tr class="list-item-topbar list-item-topbar-content accordion-opener" data-id="<?= $project->title() ?>">
                    ...
                    <td class="list-item-content accordion-content" data-id="<?= $project->title() ?>">
