    ...
    <section class="section">
        ...
        <div class="list">
            <?php foreach ($page->children()->listed() as $project) : ?>
                <div class="list-item accordion" data-project="<?= $project->title() ?>" data-year="<?= $project->year() ?>" data-client="<?= $project->client() ?>" data-location="<?= $project->location() ?>" data-category="<?= $project->category() ?>" data-status="<?= $project->stat() ?>">
                    <div class="list-item-wrapper">
                        <ul class="list-item-topbar list-item-topbar-content accordion-opener">
                        ...
                        <div class="list-item-content accordion-content">
